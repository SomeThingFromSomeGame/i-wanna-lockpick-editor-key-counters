...
static func save_level(level: LevelData, data: ByteAccess) -> void:
	...
	data.store_u8(level.world_clear)
	data.store_u8(level.reward)
	data.store_u8(level.bgcolor.r8)
	data.store_u8(level.bgcolor.g8)
	data.store_u8(level.bgcolor.b8)
...
static func load_level(data: ByteAccess) -> LevelData:
	...
	level.world_clear = data.get_u8()
	level.reward = data.get_u8()
	level.bgcolor = Color8(data.get_u8(), data.get_u8(), data.get_u8())
